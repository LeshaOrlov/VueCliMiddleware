<template>
    <div>
        ...
        <ul>
            ...
            <li><a href="https://cli.vuejs.org/">Vue CLI </a> Standard Tooling for Vue.js Development </li>
            <li><a href="https://vuetifyjs.com">Vuetify</a> for layout and styling</li>
        </ul>
        <p>To help you get started, we've also set up:</p>
        <ul>
            <li><strong>Client-side navigation</strong>. For example, click <em>Counter</em> then <em>Back</em> to return here.</li>
            <li><strong>Vue CLI dev middleware</strong>. In development mode, there's no need to run the <code>Vue CLI</code> build tool. Your client-side resources are dynamically built on demand. Updates are available as soon as you modify any file.</li>
